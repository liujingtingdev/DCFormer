...
config.model.Lifting_net = edict()
config.model.Lifting_net.volume_aggregation_method = "softmax"
config.model.Lifting_net.use_gt_pelvis = False
config.model.Lifting_net.cuboid_size = 2500.0
config.model.Lifting_net.volume_size = 64
config.model.Lifting_net.volume_multiplier = 1.0
config.model.Lifting_net.volume_softmax = True
config.model.Lifting_net.use_feature_v2v = True
config.model.Lifting_net.att_channels = 51
config.model.Lifting_net.temperature = 1500
...
config.model.poseformer.levels = 5
...
config.train.Lifting_net_lr_step = [1000]
config.train.Lifting_net_lr_factor = 0.5
