...
data_path = '/MPI_INF_3DHP/mpi_inf_3dhp_test_set'
...
for root, dirs, files in os.walk(data_path):
	...
	for file in files:
		if file.endswith("mat"):
			...
			output_path = os.path.join(out_root, path[-1], 'imageSequence')
			...
			for i in range(data_2d.shape[0]):
				...
				img_path = os.path.join(root, 'imageSequence', f'img_{int(i)+1:06d}.jpg')
